...
A command line utility is provided to configure the provisioning, network credentials or application settings.
On boot a command prompt will be available if a key is press within one second.
